defmodule Aesir.ZoneServer.Mmo.Skill.SmEndureTest do
  use ExUnit.Case, async: true
  import Mimic

  alias Aesir.ZoneServer.Mmo.Skill.Behaviors
  alias Aesir.ZoneServer.Mmo.Skill.Behaviors.SmEndure
  alias Aesir.ZoneServer.Mmo.Skill.Catalog
  alias Aesir.ZoneServer.Mmo.StatusEffect.Interpreter, as: StatusInterpreter

  setup :verify_on_exit!

  test "Behaviors.module_for/1 resolves sm_endure" do
    assert {:ok, SmEndure} = Behaviors.module_for(:sm_endure)
  end
