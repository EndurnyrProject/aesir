defmodule Aesir.ZoneServer.Mmo.Skills.AcolytePriestMonkRequirementsTest do
  ...
  @requirements %{
    ...
    Aesir.ZoneServer.Mmo.Skills.Acolyte.AlIncagi => [:player_state],
    Aesir.ZoneServer.Mmo.Skills.Acolyte.AlPneuma => [],
    Aesir.ZoneServer.Mmo.Skills.Acolyte.AlTeleport => [],
    Aesir.ZoneServer.Mmo.Skills.Priest.PrKyrie => [:player_state],
    Aesir.ZoneServer.Mmo.Skills.Priest.PrLexaeterna => [:player_state],
    Aesir.ZoneServer.Mmo.Skills.Priest.PrLexdivina => [:player_state],
