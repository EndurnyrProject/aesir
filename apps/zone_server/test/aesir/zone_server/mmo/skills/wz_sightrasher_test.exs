defmodule Aesir.ZoneServer.Mmo.Skills.WzSightrasherTest do
  ...
  test "real splash damages and knocks back only hostile mobs in the radius-7 square, excluding players" do
    ...
    Enum.each(excluded, fn target_ref ->
      refute_received {:session_cast, ^target_ref, {:apply_damage, _damage, _attacker_id}}

      refute_received {:session_cast, ^target_ref, {:knocked_back, _x, _y}}
    end)
  end
end
