defmodule Aesir.ZoneServer.Mmo.Skills.Mage.MgNapalmFireballTest do
  ...
  alias Aesir.ZoneServer.Mmo.Skills.Mage.MgFireball
  alias Aesir.ZoneServer.Mmo.Skills.Mage.MgNapalmbeat
