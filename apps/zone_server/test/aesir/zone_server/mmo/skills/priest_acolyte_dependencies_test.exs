defmodule Aesir.ZoneServer.Mmo.Skills.PriestAcolyteDependenciesTest do
  ...
  alias Aesir.ZoneServer.Mmo.Skills.AlDecagi
  alias Aesir.ZoneServer.Mmo.Skills.AlDemonbane
  alias Aesir.ZoneServer.Mmo.Skills.AlDp
  ...
  alias Aesir.ZoneServer.Mmo.Skills.AlIncagi
