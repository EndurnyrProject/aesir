defmodule Aesir.ZoneServer.Mmo.Skills.SaElementTest do
  @moduledoc """
  ...
  alias Aesir.ZoneServer.Mmo.Skills.SaElementfire
  alias Aesir.ZoneServer.Mmo.Skills.SaElementground
  alias Aesir.ZoneServer.Mmo.Skills.SaElementwater
  alias Aesir.ZoneServer.Mmo.Skills.SaElementwind
