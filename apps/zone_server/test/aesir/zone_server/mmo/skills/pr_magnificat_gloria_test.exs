defmodule Aesir.ZoneServer.Mmo.Skills.PrMagnificatGloriaTest do
  ...
  alias Aesir.ZoneServer.Mmo.Skills.PrGloria
  alias Aesir.ZoneServer.Mmo.Skills.PrMagnificat
