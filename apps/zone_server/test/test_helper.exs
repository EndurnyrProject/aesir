...
Mimic.copy(Aesir.ZoneServer.Unit.Player.GuildSync)
...
Mimic.copy(Aesir.ZoneServer.Mmo.StatusEffect.Dispel)
...
Mimic.copy(Aesir.ZoneServer.Mmo.Combat.EquipBreak)
Mimic.copy(Aesir.ZoneServer.Mmo.Combat.TargetResolver)
Mimic.copy(Aesir.ZoneServer.Mmo.Combat.AttackValidator)
Mimic.copy(Aesir.ZoneServer.CharacterPersistence)
Mimic.copy(Aesir.ZoneServer.Unit.Trade.Exchange)
...
Mimic.copy(Aesir.ZoneServer.Mmo.Skill.Castability)
...
Mimic.copy(Aesir.ZoneServer.Mmo.Skills.Swordsman.SmProvoke)
Mimic.copy(Aesir.ZoneServer.Mmo.Skill.Targeting)
...
Mimic.copy(Aesir.ZoneServer.Mmo.ItemManagement.ItemGroups)
...
Mimic.copy(Aesir.ZoneServer.Unit.Player.Handlers.MountHandler)
...
Mimic.copy(Aesir.ZoneServer.Unit.Player.Handlers.GuildHandler)
Mimic.copy(Aesir.ZoneServer.Party.Manager)
Mimic.copy(Aesir.ZoneServer.Guild.Manager)
Mimic.copy(Aesir.ZoneServer.Guild.Relations)
Mimic.copy(Aesir.ZoneServer.Guild.Tax)
...
Mimic.copy(Aesir.ZoneServer.Mmo.Woe.CastleDb)
Mimic.copy(Aesir.ZoneServer.Mmo.Woe.CastleStore)
Mimic.copy(Aesir.ZoneServer.Mmo.Woe.CastleVerifier)
Mimic.copy(Aesir.ZoneServer.Mmo.Woe.Persistence)
Mimic.copy(Aesir.ZoneServer.Mmo.Woe.Server)
Mimic.copy(Aesir.ZoneServer.Mmo.Woe.Economy)
Mimic.copy(Aesir.ZoneServer.Mmo.Woe.Treasure)
Mimic.copy(Aesir.ZoneServer.Mmo.Woe.Guardians)
Mimic.copy(Aesir.ZoneServer.Mmo.Woe.Services)
Mimic.copy(Aesir.ZoneServer.Mmo.Woe.CastleMobs)
