defmodule Aesir.ZoneServer.Mmo.StatusEffect.Effects.AspdPotion1 do
  @moduledoc """
  Attack-speed potion, tier 1 (SC_ASPDPOTION1).

  Grants flat ASPD points by `val1` for the duration (renewal
  `status.cpp:8285-8286`; items pass 6).
  ...
  use Aesir.ZoneServer.Mmo.StatusEffect.Definition,
    ...
    end_on_start: [:sc_aspdpotion0, :sc_aspdpotion2, :sc_aspdpotion3]
