defmodule Aesir.ZoneServer.Mmo.StatusEffect.Effects.AspdPotion2 do
  @moduledoc """
  Attack-speed potion, tier 2 (SC_ASPDPOTION2).

  Grants flat ASPD points by `val1` for the duration (renewal
  `status.cpp:8285-8286`; items pass 9).
  ...
  use Aesir.ZoneServer.Mmo.StatusEffect.Definition,
    ...
    properties: [:buff],
    calc_flags: [:aspd],
    icon: :atthaste_potion3,
    end_on_start: [:sc_aspdpotion0, :sc_aspdpotion1, :sc_aspdpotion3]
