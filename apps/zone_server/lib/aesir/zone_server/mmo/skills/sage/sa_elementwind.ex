defmodule Aesir.ZoneServer.Mmo.Skills.Sage.SaElementwind do
  @moduledoc """
  Elemental Change Wind (SA_ELEMENTWIND). A quest skill that
  turns a monster's defence element into wind for 30 minutes, for 30 SP, an
