defmodule Aesir.ZoneServer.Mmo.Skills.Sage.SaFlamelauncher do
  @moduledoc """
  Flame Launcher (SA_FLAMELAUNCHER). Endows an ally's weapon with the fire
  element, applying SC_FIREWEAPON.
  ...
  def cast(%{character_id: caster_id} = caster, target, level, definition) do
    ...
    case StatusInterpreter.apply_status(:player, target_id, :sc_fireweapon,
           val1: level,
           caster_id: caster_id,
           duration: duration
         ) do
