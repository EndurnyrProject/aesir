defmodule Aesir.ZoneServer.Mmo.Skills.Sage.SaSeismicweapon do
  @moduledoc """
  Seismic Weapon (SA_SEISMICWEAPON). Endows an ally's weapon with the earth element; a bare-handed
  ...
  use Aesir.ZoneServer.Mmo.Skill,
    ...
    item_cost: [renewal: [%{id: 6363, amount: 1}], pre_renewal: [%{id: 993, amount: 1}]],
    duration: [
  ...
  def cast(caster, target, level, definition),
    do: Endow.cast(caster, target, level, definition, :sc_earthweapon)
