defmodule Aesir.ZoneServer.Mmo.Skills.Npc.NpcHolyattack do
  @moduledoc """
  Holy Attack (NPC_HOLYATTACK). Monster-only single-target holy weapon hit.

  rAthena: flat 100% ATK holy-element weapon damage at every level. Many mob
