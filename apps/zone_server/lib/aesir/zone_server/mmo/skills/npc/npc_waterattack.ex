defmodule Aesir.ZoneServer.Mmo.Skills.Npc.NpcWaterattack do
  @moduledoc """
  Water Attack (NPC_WATERATTACK). Monster-only single-target water weapon hit.

  rAthena: flat 100% ATK water-element weapon damage at every level. Many mob
