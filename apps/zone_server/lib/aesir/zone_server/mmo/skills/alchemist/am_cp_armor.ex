defmodule Aesir.ZoneServer.Mmo.Skills.Alchemist.AmCpArmor do
  @moduledoc "Chemical Protection Armor (AM_CP_ARMOR)."

  use Aesir.ZoneServer.Mmo.Skill,
    id: 236,
    name: :am_cp_armor,
    status: :sc_cp_armor,
    display_name: "Chemical Protection Armor",
    max_level: 5,
  ...
  def cast(%{character_id: caster_id} = caster, target, level, definition) do
    ...
    case StatusInterpreter.apply_status(:player, target_id, :sc_cp_armor,
           val1: level,
           caster_id: caster_id,
