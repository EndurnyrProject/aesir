defmodule Aesir.ZoneServer.Mmo.Skills.SmMagnum do
  @moduledoc """
  ...
  caster's own cell, knocks each hit target back, and self-applies
  SC_WATK_ELEMENT (fire) for the buff duration. The 2000ms cooldown is applied by
  ...
  use Aesir.ZoneServer.Mmo.Skill,
    ...
    cooldown: List.duplicate(2000, 10),
  ...
  # rAthena element index for fire, passed to SC_WATK_ELEMENT.
  @fire_element 3
