defmodule Aesir.ZoneServer.Mmo.Skills.AlAngelus do
  @moduledoc """
  Angelus (AL_ANGELUS). Applies SC_ANGELUS to the caster only.

  Party-wide splash is deferred until the party system is implemented.
  rAthena: val1 = skill level, val2 = 5 * level (VIT DEF% bonus),
  duration = 30s per level (30s → 300s).
  """
