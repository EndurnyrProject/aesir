defmodule Aesir.ZoneServer.Content.Npc.LhzAirport.AirportStaff do
  @moduledoc """
  ...
  use Aesir.ZoneServer.Npc,
    spawn: [
      ...
      %{map: "lhz_airport", x: 158, y: 43, dir: 5, sprite: 90, name: "Airship Staff"},
      %{map: "lhz_airport", x: 126, y: 43, dir: 5, sprite: 90, name: "Airship Staff"}
    ]
