defmodule Aesir.ZoneServer.Content.Npc.Jobs.M21.Priest.Zombie41 do
  @moduledoc """
  Invisible trigger that releases the fourth wave of zombies in the Priest spiritual training.
  ...
  def on_event("OnInit", ctx), do: disablenpc(ctx, "Zombie4_1")
  ...
  def on_event("OnEnable", ctx), do: enablenpc(ctx, "Zombie4_1")
  def on_event("OnDisable", ctx), do: disablenpc(ctx, "Zombie4_1")
