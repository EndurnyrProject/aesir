defmodule Aesir.ZoneServer.Content.Npc.Jobs.M22.Rogue.GenRo do
  @moduledoc """
  Springs a monster ambush on Rogue candidates in the job test tunnel.

  ## Behavior

  - Summons two Zombies when a Thief steps into its trigger area.
  ...
  @mob_dead_event "gen_ro#1::OnMyMobDead"
  ...
  def on_event("OnTouch", ctx) do
    if Rathena.job_id(base_job(ctx)) == Rathena.job_id(:thief) do
      ctx
      |> summon_mob(mob_id: 1015, map: "in_rogue", at: {200, 389}, event: @mob_dead_event)
      |> summon_mob(mob_id: 1015, map: "in_rogue", at: {201, 389}, event: @mob_dead_event)
