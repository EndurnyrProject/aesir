defmodule Aesir.ZoneServer.Content.Npc.Jobs.M21.Wizard.WizardGuildsman do
  @moduledoc """
  Transpiled from rAthena jobs/2-1/wizard.txt:32 (Wizard Guildsman).
  ...
  use Aesir.ZoneServer.Npc,
    spawn: [%{map: "gef_tower", x: 111, y: 37, dir: 4, sprite: 70, name: "Wizard Guildsman"}]
  ...
  def on_talk(ctx) do
    ...
    ctx =
      if base_job(ctx) != :mage do
          ...
          if base_job(ctx) == :wizard do
            ...
            ctx =
              if sex(ctx) == get_char_var(ctx, :SEX_MALE, 0) do
                mes(ctx, "Well, If you intended to ask me on a date... I appreciate it...hohoho.")
              else
                mes(ctx, "Well, if you fix me up with a cute guy... I'd appreciate it...hohoho!.")
              end
        ...
        ctx = ctx |> next() |> mes("[Wizard Guildsman]") |> mes("Ok, then. Farewell.") |> close()
        throw({:script_end, ctx})
      else
        ctx
      end
      ...
      if get_char_var(ctx, :WIZ_Q, 0) == 0 do
          ...
          if v1 == 1 do
            ...
            ctx =
              if v2 == 1 do
                ...
                ctx =
                  ctx |> mes("[Catherine]") |> mes("Very well then, I accept your application.")
                ...
                ctx =
                  ...
                  |> mes(
                    Rathena.concat(
                      ...
                      ", isn't it? I am not sure if I pronounced it correctly?"
                    )
                  )
                  |> next()
                  |> mes("[Catherine]")
        ...
        ctx =
          if get_char_var(ctx, :WIZ_Q, 0) == 1 do
            ...
            ctx =
              if count_item(ctx, 716) > 9 and count_item(ctx, 717) > 9 and
                   count_item(ctx, 715) > 9 do
                ctx =
                  ctx
                  |> mes("[Catherine]")
            ...
            ctx =
              if get_char_var(ctx, :WIZ_Q, 0) == 2 do
                ...
                ctx =
                  if count_item(ctx, 991) > 4 and count_item(ctx, 993) > 4 and
                       count_item(ctx, 990) > 4 and count_item(ctx, 992) > 4 do
                    ctx =
                      ctx
                      |> mes("[Catherine]")
                            ...
                            1 ->
                              ctx =
                                if count_item(ctx, 531) > 0 do
                                  ...
                                  |> mes(
                                    "*sigh*...He'd look much better if he cut his hair and shaved..."
                                  )
                                  |> mes(
                                  ...
                                  |> mes("[Catherine]")
                                  |> mes(
                                    "Like I said, I'll think about it if you give me 1 Apple Juice."
                                  )
                                  |> mes(
                              ...
                              if get_char_var(ctx, :WIZ_Q, 0) == 6 do
                                ...
                                ctx =
                                  if sex(ctx) == get_char_var(ctx, :SEX_MALE, 0) do
                                    ...
                                    |> mes(
                                      "You came all this way to become a Wizard! Now come on, you can do it!!"
                                    )
                                    |> next()
                                    |> mes("[Catherine]")
                                    |> mes(
                                ...
                                ctx =
                                  if get_char_var(ctx, :WIZ_Q, 0) == 7 do
                                    ...
                                    {ctx, _} =
                                      ...
                                      |> mes("[Catherine]")
                                      |> mes(
                                        "Well, no need to wait, I congratulate you. I hearby deem you Wizard."
                                      )
                                      |> next()
                                      |> completequest(9018)
                                      |> jobchange(:wizard)
                                    ...
                                    ctx =
                                      ...
                                      |> mes(
                                        "A Wizard's magic is meant for their own battles with monsters."
                                      )
                                      |> next()
                                      |> mes("[Catherine]")
