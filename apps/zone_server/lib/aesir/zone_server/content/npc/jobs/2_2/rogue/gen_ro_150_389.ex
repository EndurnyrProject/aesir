defmodule Aesir.ZoneServer.Content.Npc.Jobs.M22.Rogue.GenRo150389 do
  ...
  - Summons a Zombie and a Mummy when a Thief steps into its trigger area.
  ...
  @mob_dead_event "gen_ro#3::OnMyMobDead"
  ...
  def on_event("OnTouch", ctx) do
    if Rathena.job_id(base_job(ctx)) == Rathena.job_id(:thief) do
      ctx
      |> summon_mob(mob_id: 1015, map: "in_rogue", at: {145, 389}, event: @mob_dead_event)
      |> summon_mob(mob_id: 1041, map: "in_rogue", at: {143, 389}, event: @mob_dead_event)
