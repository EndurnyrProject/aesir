defmodule Aesir.ZoneServer.Content.Npc.Jobs.M22.Crusader.MonsterSummon16845 do
  @moduledoc """
  Transpiled from rAthena jobs/2-2/crusader.txt:1315 (Monster Summon#cr1).
  ...
  def ev_oninit(ctx) do
    disablenpc(ctx, "Monster Summon#cr1")
  end

  def ev_ontouch(ctx) do
    ctx |> donpcevent("Monster Summon#cr0::OnMonster1") |> donpcevent("Monster Summon#cr1::OnEnd")
  end

  def ev_onstart(ctx) do
    enablenpc(ctx, "Monster Summon#cr1")
  end
