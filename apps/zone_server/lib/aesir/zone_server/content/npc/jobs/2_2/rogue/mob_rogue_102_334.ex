defmodule Aesir.ZoneServer.Content.Npc.Jobs.M22.Rogue.MobRogue102334 do
  ...
  - Summons a Khalitzburg when a Thief steps into its trigger area.
  ...
  @mob_dead_event "mob_rogue#5::OnMyMobDead"
  ...
  def on_event("OnTouch", ctx) do
    if Rathena.job_id(base_job(ctx)) == Rathena.job_id(:thief) do
      ctx
      |> summon_mob(mob_id: 1132, map: "in_rogue", at: {92, 334}, event: @mob_dead_event)
