defmodule Aesir.ZoneServer.Content.Npc.Jobs.M22.Rogue.MobRogue58309 do
  @moduledoc """
  ...
  @mob_dead_event "mob_rogue#6::OnMyMobDead"
  ...
  def on_event("OnTouch", ctx) do
    if Rathena.job_id(base_job(ctx)) == Rathena.job_id(:thief) do
      ctx
      |> summon_mob(mob_id: 1132, map: "in_rogue", at: {57, 301}, event: @mob_dead_event)
