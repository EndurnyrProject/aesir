defmodule Aesir.ZoneServer.Content.Npc.Jobs.M22.Rogue.MobRogue223187 do
  @moduledoc """
  Springs a monster ambush on Rogue candidates in the job test tunnel.

  ## Behavior

  - Summons three Abysmal Knights when a Thief steps into its trigger area.
  ...
  @mob_dead_event "mob_rogue#13::OnMyMobDead"
  ...
  def on_event("OnTouch", ctx) do
    if Rathena.job_id(base_job(ctx)) == Rathena.job_id(:thief) do
      ctx
      |> summon_mob(mob_id: 1219, map: "in_rogue", at: {236, 186}, event: @mob_dead_event)
      |> summon_mob(mob_id: 1219, map: "in_rogue", at: {238, 186}, event: @mob_dead_event)
      |> summon_mob(mob_id: 1219, map: "in_rogue", at: {234, 186}, event: @mob_dead_event)
