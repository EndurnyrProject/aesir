defmodule Aesir.ZoneServer.Content.Npc.Jobs.M22.Rogue.GenRo100389 do
  @moduledoc """
  Springs a monster ambush on Rogue candidates in the job test tunnel.

  ## Behavior

  - Summons a Mummy when a Thief steps into its trigger area.
  ...
  @mob_dead_event "gen_ro#2::OnMyMobDead"
  ...
  def on_event("OnTouch", ctx) do
    if Rathena.job_id(base_job(ctx)) == Rathena.job_id(:thief) do
      ctx
      |> summon_mob(mob_id: 1041, map: "in_rogue", at: {100, 389}, event: @mob_dead_event)
