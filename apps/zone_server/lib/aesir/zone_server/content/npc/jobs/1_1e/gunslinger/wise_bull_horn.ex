defmodule Aesir.ZoneServer.Content.Npc.Jobs.M11e.Gunslinger.WiseBullHorn do
  @moduledoc """
  Wise Bull Horn, the shaman who crafts the voucher required by the Gunslinger job quest.

  ## Behavior

  - Reads Master Miller's letter and asks for the voucher materials.
  - Takes the materials, then asks the applicant for a glass of Milk.
  - Takes the Milk and approves the applicant with the finished voucher.
  ...
  defp list_voucher_materials(ctx) do
    ctx
    |> mes("[Wise Bull Horn]")
