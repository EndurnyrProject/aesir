defmodule Aesir.ZoneServer.Content.Npc.Jobs.M22.Rogue.MobRogue15273 do
  ...
  @mob_dead_event "mob_rogue#2::OnMyMobDead"
  ...
  def on_event("OnTouch", ctx) do
    if Rathena.job_id(base_job(ctx)) == Rathena.job_id(:thief) do
      ctx
      |> summon_mob(mob_id: 1041, map: "in_rogue", at: {15, 276}, event: @mob_dead_event)
      |> summon_mob(mob_id: 1041, map: "in_rogue", at: {13, 276}, event: @mob_dead_event)
      |> summon_mob(mob_id: 1041, map: "in_rogue", at: {11, 276}, event: @mob_dead_event)
    else
