defmodule Aesir.ZoneServer.Content.Npc.PreRe.Jobs.M22.Crusader.MonsterSummon do
  @moduledoc """
  Transpiled from rAthena pre-re/jobs/2-2/crusader.txt:40 (Monster Summon#cr5).
