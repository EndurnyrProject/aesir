defmodule Aesir.ZoneServer.Content.Npc.PrtChurch.Cleric do
  @moduledoc """
  ...
  use Aesir.ZoneServer.Npc,
    spawn: [%{map: "prt_church", x: 184, y: 41, dir: 4, sprite: 60, name: "Cleric"}]
  ...
  def on_talk(ctx) do
    ctx =
      if get_char_var(ctx, :Upper, 0) == 1 do
        if get_char_var(ctx, :ADVJOB, 0) == get_char_var(ctx, :Job_High_Priest, 0) or
             get_char_var(ctx, :ADVJOB, 0) == get_char_var(ctx, :Job_Champion, 0) do
