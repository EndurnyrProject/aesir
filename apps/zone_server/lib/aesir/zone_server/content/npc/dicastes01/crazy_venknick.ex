defmodule Aesir.ZoneServer.Content.Npc.Dicastes01.CrazyVenknick do
  @moduledoc """
  ...
  use Aesir.ZoneServer.Npc,
    spawn: [%{map: "dicastes01", x: 202, y: 197, dir: 4, sprite: 449, name: "Crazy Venknick"}]
    ...
    ctx =
      if Rathena.truthy?(is_equipped(ctx, 2782)) do
        ...
        ctx =
          ...
          |> mes(Rathena.concat(Rathena.concat("[", char_name(ctx, 0)), "]"))
          |> mes("Was I tricked?")
          |> sc_start(Todo.const!(:SC_Blind), 20000, 0)
          |> next()
