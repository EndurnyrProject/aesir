defmodule Aesir.ZoneServer.Content.Npc.Cities.Lighthalzen.Vergil do
  @moduledoc """
  Answers questions about leisure, work, and a local serial-killer rumor.

  ## Behavior

  - Discusses the Al De Baran Turbo Track, his work obligations, or an alternate axe-murderer tale.
