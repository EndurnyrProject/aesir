defmodule Aesir.ZoneServer.Content.Npc.Cities.Aldebaran.ForgerMunster do
  @moduledoc """
  Explains safe equipment upgrade limits and his blacksmith family.
  ...
  use Aesir.ZoneServer.Npc,
    ...
    spawn: [
      %{
        ...
        name: "Forger Munster",
        scope: :shared,
        unique_name: "Forger Munster#alde"
      }
    ]
