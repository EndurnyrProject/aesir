defmodule Aesir.ZoneServer.Content.Npc.Cities.Einbech.Franz do
  @moduledoc """
  Shares stories about Einbech’s dangerous creatures and recent incidents.

  ## Behavior

  - Offers a choice between the legend of Ungoliant and the Einbroch teddy bear incident.
