defmodule Aesir.ZoneServer.Content.Npc.Cities.Lighthalzen.RekenberGuardTan do
  @moduledoc """
  Shares Rekenber Guard Tan's remarks with visitors to Lighthalzen.
  ...
  use Aesir.ZoneServer.Npc,
    ...
    spawn: [
      %{
        ...
        dir: 3,
        sprite: 867,
        name: "Rekenber Guard Tan",
        scope: :shared,
        unique_name: "Rekenber Guard Tan#li"
      }
    ]
