defmodule Aesir.ZoneServer.Content.Npc.Cities.Einbech.Shena do
  @moduledoc """
  Explains the monsters around Einbroch with her daughter Luda.

  ## Behavior

  - Offers a repeating menu about Metalling, Mineral, Pit Man, and Old Stove.
  - Adds extra dialogue when speaking to a male character.
  ...
  defp monster_menu(ctx) do
    {ctx, choice} = select(ctx, ["Metalling", "Mineral", "Pit Man", "Old Stove", "Quit"])
