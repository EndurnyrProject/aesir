defmodule Aesir.ZoneServer.Content.Npc.Airports.Lighthalzen.ArrivalStaff do
  @moduledoc """
  Guides arriving passengers from the Lighthalzen boarding area to the main terminal.
  ...
  use Aesir.ZoneServer.Npc,
    ...
    spawn: [
      ...
      %{
        ...
        name: "Arrival Staff",
        scope: :shared,
        unique_name: "Arrival Staff#lhz_air2b"
      },
      %{
        map: "lhz_airport",
        x: 158,
        ...
        name: "Arrival Staff",
        scope: :shared,
        unique_name: "Arrival Staff#lhz_air2c"
      }
    ]
  ...
  defp confirm_exit(ctx) do
    ...
    if choice == 1, do: warp(ctx, "lhz_airport", 142, 40), else: farewell(ctx)
  end
