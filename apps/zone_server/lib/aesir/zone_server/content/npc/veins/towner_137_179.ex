defmodule Aesir.ZoneServer.Content.Npc.Veins.Towner137179 do
  @moduledoc """
  Transpiled from rAthena cities/veins.txt:66 (Towner#ve3).
  ...
  use Aesir.ZoneServer.Npc,
    spawn: [%{map: "veins", x: 137, y: 179, dir: 5, sprite: 943, name: "Towner"}]
