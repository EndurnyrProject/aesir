defmodule Aesir.ZoneServer.Content.Npc.Yuno.AirshipStaff88263 do
  @moduledoc """
  Transpiled from rAthena airports/yuno.txt:145 (Airship Staff#yuno02).
  ...
  use Aesir.ZoneServer.Npc,
    spawn: [%{map: "yuno", x: 88, y: 263, dir: 3, sprite: 91, name: "Airship Staff"}]
