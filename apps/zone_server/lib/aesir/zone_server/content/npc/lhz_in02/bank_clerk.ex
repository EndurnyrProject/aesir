defmodule Aesir.ZoneServer.Content.Npc.LhzIn02.BankClerk do
  @moduledoc """
  ...
  use Aesir.ZoneServer.Npc,
    spawn: [
      ...
      %{map: "lhz_in02", x: 21, y: 25, dir: 7, sprite: 86, name: "Bank Clerk"},
      %{map: "lhz_in02", x: 34, y: 22, dir: 1, sprite: 755, name: "Bank Clerk"}
    ]
