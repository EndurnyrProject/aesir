defmodule Aesir.ZoneServer.Content.Npc.PayonIn02.ArcherGuildsman do
  @moduledoc """
  ...
  use Aesir.ZoneServer.Npc,
    spawn: [%{map: "payon_in02", x: 64, y: 71, dir: 4, sprite: 85, name: "Archer Guildsman"}]
    ...
    ctx =
      if get_char_var(ctx, :Upper, 0) == 1 do
        if class(ctx) == get_char_var(ctx, :Job_Novice_High, 0) and
             (get_char_var(ctx, :ADVJOB, 0) == get_char_var(ctx, :Job_Sniper, 0) or
                get_char_var(ctx, :ADVJOB, 0) == get_char_var(ctx, :Job_Clown, 0) or
                get_char_var(ctx, :ADVJOB, 0) == get_char_var(ctx, :Job_Gypsy, 0)) do
          ctx =
            ctx
      ...
      case v2 do
        1 ->
          ...
          if get_char_var(ctx, :BaseJob, 0) != :novice do
            ctx =
              if get_char_var(ctx, :BaseJob, 0) == :archer do
