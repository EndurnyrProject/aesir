defmodule Aesir.ZoneServer.Content.Npc.PrtFild03.Ascetic do
  @moduledoc """
  Transpiled from rAthena re/jobs/1-1/acolyte.txt:113 (Ascetic#aco).
  ...
  use Aesir.ZoneServer.Npc,
    spawn: [%{map: "prt_fild03", x: 365, y: 255, dir: 2, sprite: 89, name: "Ascetic"}]
