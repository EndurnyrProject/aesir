defmodule Aesir.ZoneServer.EtsTable do
  ...
  defp castle_tables(seed) do
    ...
    # emperium_unit_id, economy, defense, invested_economy, invested_defense, guardians, kafra}.
  ...
  if Mix.env() == :test do
    # Test-only clause: the seed prefix is generated by the test helper so async
    # tests get isolated ETS tables. Not compiled outside :test.
