defmodule Aesir.ZoneServer.Npc.Transpiler.CommandMap do
  ...
  @commands %{
    ...
    "resetlvl" => %{dsl: "resetlvl", args: [:int]},
    "resetskill" => %{shape: :nullary, dsl: "reset_skills"},
    ...
    "soundeffectall" => %{dsl: "soundeffectall", args: [:string, :int]},
    ...
    "mapwarp" => %{
      dsl: "mapwarp",
      args: [:string, :string, :int, :int, :int, :int]
    },
  ...
  @call_reads %{
    ...
    "getguildname" => %{dsl: "getguildname", args: [:int]},
