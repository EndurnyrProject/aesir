defmodule Aesir.Repo.Migrations.CreateCartInventory do
  use Ecto.Migration

  def change do
    create table(:cart_inventory) do
    ...
    create index(:cart_inventory, [:char_id])

    alter table(:characters) do
      add :cart, :smallint, null: false, default: 0
    end
  end
end
